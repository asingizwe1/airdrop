...
contract SplitSignature is Script {
    ...
    function run() external {
        ...
        bytes memory sigBytes = vm.parseBytes(sig);//read the signature from file and pass the bytes 
        ...
        console.log("s value:");
        console.logBytes32(s);//log to the terminal such that interact can read from the terminal
    }
}